...
<html>
  <head>
    ...
    <component :is="'script'" type="text/javascript" src="https://cdn.jsdelivr.net/npm/chart.js@3.5.1/dist/chart.min.js"></component>
  </head>
  <body>
